...
opts_chunk$set(tidy.opts = list(width.cutoff = 40), tidy = TRUE, fig.height = 6, fig.width = 9)
```
...
# Effect on society
Using data science to predict the salary of a NBA player can help the management of a team to make better judgement. It would help the team to cut cost and put the money into charity work that would benefit the society.  


This study can give insights to the effect of different attributes on the NBA player. This can help the player to know where should they focus on improving and thus pushing the development of NBA.
